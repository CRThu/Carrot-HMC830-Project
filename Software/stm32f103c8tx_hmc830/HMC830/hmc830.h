...
// CONFIG GPIO
#define HMC830_SCK(x)   HAL_GPIO_WritePin(GPIOA, HMC830_SCK_Pin, ((x)==0 ? GPIO_PIN_RESET : GPIO_PIN_SET))
#define HMC830_SEN(x)   HAL_GPIO_WritePin(GPIOA, HMC830_SEN_Pin, ((x)==0 ? GPIO_PIN_RESET : GPIO_PIN_SET))
...
#define HMC830_REG04H_FACTIONAL_PART                        0x04
...
#define HMC830_REG12H_GPO_MASK                              0x00000000
#define HMC830_REG12H_LOCK_DETECT_MASK                      0x00000001
